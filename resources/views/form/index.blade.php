            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-12 m-3">
                        <h3>Dynamic form</h3>
                        <a href="{{route('forms.create')}}" class="btn btn-sm btn-primary">Create</a>
                    </div>
                    <div class="col-md-12">
                            ...
                            <tbody>
                                @forelse ($forms as $key => $form)
                                    <tr>
                                        ...
                                        <td>{{$form->is_required == 1 ? 'True' : 'False'}}</td>
                                        <td>{{$form->level_name}}</td>
                                    </tr>
                                @empty
                                    <tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addField').on('click', function(e) {
                e.preventDefault();
                var lastRow = $('#dynamicForm .form-row:last');
                var newRow = lastRow.clone();
    
                // Find all form fields in the new row and update their names
                newRow.find('select, input').each(function() {
                    var currentName = $(this).attr('name');
                    var newIndex = lastRow.index() + 1;
    
                    // Update the name attribute by replacing [0] with the new index
