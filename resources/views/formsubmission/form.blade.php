        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{route('formSubmissions.store')}}" method="POST">
                          @csrf
                            <div class="row">
                                    ...
                                    @if ($form->field_type == 'text')
                                        <div class="mb-3 col-md-4">
                                            <label for="roleTitle" class="form-label">{{ $form->level_name }}
                                                {!! $form->is_required == 1 ? '<span class="text-danger">*</span>' : '' !!}</label>
                                            <input type="text" name="{{ $form->field_type }}" class="form-control"
                                                id="roleTitle" aria-describedby="roleTitle" {!! $form->is_required == 1 ? 'required' : '' !!}>
                                        </div>
                                    @endif
