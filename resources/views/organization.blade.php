        ...
        <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-4">
                    <form>
                        <div class="mb-3">
                          <label for="roleTitle" class="form-label">Name</label>
                          <input type="text" class="form-control" id="roleTitle" aria-describedby="roleTitle" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Submit</button>
                      </form>
                </div>
                <div class="col-md-8">
                    <table class="table table-sm table-borderd table-striped table-hover">
                        <thead>
                            <th>Sl</th>
                            <th>Name</th>
                        </thead>
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="2">no ogranizations found..!</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
